...
CREATE  TABLE IF NOT EXISTS `m2`.`users` (
  ...
  `total_regs` INT NULL ,
  `new_pass_code` VARCHAR(45) NULL ,
  `new_pass_datetime` DATETIME NULL ,
  `created_at` DATETIME NULL ,
  `updated_at` DATETIME NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `m2`.`frauds` (
  ...
  `footprint` VARCHAR(180) NOT NULL ,
...
-- Table `m2`.`settings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `m2`.`settings` ;

CREATE  TABLE IF NOT EXISTS `m2`.`settings` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `wl_id` INT NOT NULL ,
  ...
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_settings_white_label1` (`wl_id` ASC) ,
...
SET AUTOCOMMIT=0;
USE `m2`;
INSERT INTO `m2`.`users` (`id`, `municipal_id`, `wl_id`, `level`, `email`, `email_confirmed`, `password`, `f_name`, `l_name`, `nick`, `sex`, `born`, `descr`, `last_login`, `img_filename`, `avatar_filename`, `customer_id`, `paid_until`, `trophy_start`, `status`, `company_key_temp`, `sources_id`, `total_steps`, `total_steps_current`, `total_logins`, `total_regs`, `new_pass_code`, `new_pass_datetime`, `created_at`, `updated_at`) VALUES ('1', '1', '1', '99', 'krillo@gmail.com', '1', 'kapten', 'krillo', 'superadmin', '99', 'MALE', '1977-03-03 12:00:00', NULL, NULL, NULL, 'avatar1.gif', NULL, '2012-03-03 12:00:00', '2011-03-03 12:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-03 12:00:00', '2011-03-03 12:00:00');
INSERT INTO `m2`.`users` (`id`, `municipal_id`, `wl_id`, `level`, `email`, `email_confirmed`, `password`, `f_name`, `l_name`, `nick`, `sex`, `born`, `descr`, `last_login`, `img_filename`, `avatar_filename`, `customer_id`, `paid_until`, `trophy_start`, `status`, `company_key_temp`, `sources_id`, `total_steps`, `total_steps_current`, `total_logins`, `total_regs`, `new_pass_code`, `new_pass_datetime`, `created_at`, `updated_at`) VALUES ('2', '3', '1', '51', 'emma@boyhappy.se', '1', 'kapten', 'emma', 'p', '41', 'FEMALE', '1977-03-03 12:00:00', NULL, NULL, NULL, 'avatar7.gif', NULL, '2012-03-03 12:00:00', '2011-03-03 12:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-03 12:00:00', '2011-03-03 12:00:00');
INSERT INTO `m2`.`users` (`id`, `municipal_id`, `wl_id`, `level`, `email`, `email_confirmed`, `password`, `f_name`, `l_name`, `nick`, `sex`, `born`, `descr`, `last_login`, `img_filename`, `avatar_filename`, `customer_id`, `paid_until`, `trophy_start`, `status`, `company_key_temp`, `sources_id`, `total_steps`, `total_steps_current`, `total_logins`, `total_regs`, `new_pass_code`, `new_pass_datetime`, `created_at`, `updated_at`) VALUES ('3', '2', '1', '19', 'user@boyhappy.se', '1', 'kapten', 'normal', 'user', '19', 'FEMALE', '1977-03-03 12:00:00', NULL, NULL, NULL, 'avatar2.gif', NULL, '2012-03-03 12:00:00', '2011-03-03 12:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-03 12:00:00', '2011-03-03 12:00:00');
INSERT INTO `m2`.`users` (`id`, `municipal_id`, `wl_id`, `level`, `email`, `email_confirmed`, `password`, `f_name`, `l_name`, `nick`, `sex`, `born`, `descr`, `last_login`, `img_filename`, `avatar_filename`, `customer_id`, `paid_until`, `trophy_start`, `status`, `company_key_temp`, `sources_id`, `total_steps`, `total_steps_current`, `total_logins`, `total_regs`, `new_pass_code`, `new_pass_datetime`, `created_at`, `updated_at`) VALUES ('4', '2', '2', '19', 'user2@boyhappy.se', '1', 'kapten', 'wl2', 'user', 'wl19', 'MALE', '1977-03-03 12:00:00', NULL, NULL, NULL, 'avatar3.gif', NULL, '2012-03-03 12:00:00', '2011-03-03 12:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-03 12:00:00', '2011-03-03 12:00:00');
INSERT INTO `m2`.`users` (`id`, `municipal_id`, `wl_id`, `level`, `email`, `email_confirmed`, `password`, `f_name`, `l_name`, `nick`, `sex`, `born`, `descr`, `last_login`, `img_filename`, `avatar_filename`, `customer_id`, `paid_until`, `trophy_start`, `status`, `company_key_temp`, `sources_id`, `total_steps`, `total_steps_current`, `total_logins`, `total_regs`, `new_pass_code`, `new_pass_datetime`, `created_at`, `updated_at`) VALUES ('5', '3', '2', '71', 'admin2@boyhappy.se', '1', 'kapten', 'wl2-admin', 'admin', 'wl71', 'MALE', '1977-03-03 12:00:00', NULL, NULL, NULL, 'avatar3.gif', NULL, '2012-03-03 12:00:00', '2011-03-03 12:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-03 12:00:00', '2011-03-03 12:00:00');
INSERT INTO `m2`.`users` (`id`, `municipal_id`, `wl_id`, `level`, `email`, `email_confirmed`, `password`, `f_name`, `l_name`, `nick`, `sex`, `born`, `descr`, `last_login`, `img_filename`, `avatar_filename`, `customer_id`, `paid_until`, `trophy_start`, `status`, `company_key_temp`, `sources_id`, `total_steps`, `total_steps_current`, `total_logins`, `total_regs`, `new_pass_code`, `new_pass_datetime`, `created_at`, `updated_at`) VALUES ('6', '1', '1', '41', 'novo@boyhappy.se', '1', 'kapten', 'novoboy', 'admin', 'novo', 'FEMALE', '1977-03-03 12:00:00', NULL, NULL, NULL, 'avatar5.gif', NULL, '2012-03-03 12:00:00', '2011-03-03 12:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2011-03-03 12:00:00', '2011-03-03 12:00:00');
INSERT INTO `m2`.`users` (`id`, `municipal_id`, `wl_id`, `level`, `email`, `email_confirmed`, `password`, `f_name`, `l_name`, `nick`, `sex`, `born`, `descr`, `last_login`, `img_filename`, `avatar_filename`, `customer_id`, `paid_until`, `trophy_start`, `status`, `company_key_temp`, `sources_id`, `total_steps`, `total_steps_current`, `total_logins`, `total_regs`, `new_pass_code`, `new_pass_datetime`, `created_at`, `updated_at`) VALUES ('7', '3', '1', '19', 'jams@boyhappy.se', '1', 'kapten', 'James', 'Withouse', 'Bullbull', 'MALE', '1977-03-03 12:00:00', NULL, NULL, NULL, 'avatar6.gif', NULL, '2012-03-03 12:00:00', '2012-03-03 12:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2012-03-03 12:00:00', '2012-03-03 12:00:00');
