  ...
  function creteUsers($data){
    ...
    foreach ($data as $value) {
      $sql = "INSERT INTO `users`
            ...
            VALUES(1,1,19,'$value@boyhappy.se',1,'kapten','$value','Sirname','$value','MALE','1978-04-02 00:00:00',NULL,NULL,NULL,'avatar2.gif',NULL,'2012-04-02 00:00:00','2011-04-02 00:00:00',NULL,NULL,1,0,NULL,NULL,0,'2011-04-02 00:00:00','2011-04-02 00:00:00')";
      $query = $this->db->query($sql);
    }
