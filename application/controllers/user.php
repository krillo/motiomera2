...
class User extends CI_Controller {
  ...
  function newpass() {
    ...
    if ($user_id > 0) {
      ...
      //echo 'Sorry, the link has expired or you have entered wrong code. <a href="/user/forgotpass"><input type="button" name="back" title="Go back to Start page." value="Back" /></a>';   
    //}
  }}
